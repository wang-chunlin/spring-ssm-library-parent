...
<head>
    <title>Title</title>
    <link rel="stylesheet" type="text/css" href="/static/css/reader/readerAdd.css"/>
...
<body>
    ...
    <form  action="/readers/dengji" method="post" enctype="multipart/form-data">
        <div id="div1">
            ...
            <label>备注：</label>
            <textarea  class="form-control"  rows="3" cols="25" name="remarks"></textarea>
            <br/>
        </div>
        <div id="div2">
            <label>身份证：</label>&nbsp;&nbsp;&nbsp;
            ...
            <input type="submit" id="submit-tijiao" value="提交" onclick="setOK()">
        </div>
    </form>
