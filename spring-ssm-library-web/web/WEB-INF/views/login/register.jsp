...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/html/login/register.css">
</head>
<body>
...
<form action="/register" method="post" >
        ...
        <div class="col-md-4" id="div1">
            ...
            <div class="form-group">
                ...
                <form:errors path="nation" cssStyle="color: red"></form:errors>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <form:errors path="idcard" cssStyle="color: red"></form:errors>
            </div>
